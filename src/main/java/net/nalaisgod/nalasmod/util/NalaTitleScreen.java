...
import net.nalaisgod.nalasmod.mixin.ScreenMixin;

public class NalaTitleScreen extends TitleScreen {

    private static final Identifier SPLASH =
            new Identifier(NalasMod.MOD_ID, "textures/gui/background/nalamenu.jpg");
