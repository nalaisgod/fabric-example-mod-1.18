...
public class ModFunnyItem extends RangedWeaponItem implements IAnimatable, ISyncable {
    ...
    public ModFunnyItem(Settings properties) {
        super(properties);
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient) {
            ModBulletItem modBulletItem = (ModBulletItem) (itemStack.getItem() instanceof ModBulletItem ? itemStack.getItem() : ModItems.FREEZE_ROD);
            PersistentProjectileEntity persistentProjectileEntity = modBulletItem.createArrow(world, itemStack, playerEntity);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(Screen.hasShiftDown()) {
            tooltip.add(new TranslatableText("item.nalasmod.gun.tooltip.shift"));
        } else {
    ...
    public void onAnimationSync(int id, int state) {
        if (state == ANIM_OPEN) {
            ...
            if (controller.getAnimationState() == AnimationState.Stopped) {
                ...
                if (player != null) {
                    player.sendMessage(new LiteralText("Gun go Brrr"), true);
                }
