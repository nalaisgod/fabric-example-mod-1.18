...
public class OriginiteArmorItem extends ModArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public OriginiteArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.ORIGINITE_BOOTS,
