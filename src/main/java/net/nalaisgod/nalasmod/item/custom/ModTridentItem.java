...
import net.nalaisgod.nalasmod.entity.projectile.ModTridentEntity;
...
public class ModTridentItem extends TridentItem {
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient) {
            ...
            if (j == 0) {
                ModTridentEntity tridentEntity = new ModTridentEntity(world, (LivingEntity)playerEntity, stack);
