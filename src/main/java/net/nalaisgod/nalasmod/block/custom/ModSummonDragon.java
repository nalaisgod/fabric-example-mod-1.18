...
public class ModSummonDragon extends Block implements BlockEntityProvider {
    @Nullable
    ...
    public ModSummonDragon(Settings settings) {
        super(settings);
    }
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        ModSummonDragon.onPlaced(world, pos);
    }
    ...
    public static void onPlaced(World world, BlockPos pos) {
        ...
        BlockPattern blockPattern = ModSummonDragon.getWitherBossPattern();
        ...
        EnderDragonEntity witherEntity = EntityType.ENDER_DRAGON.create(world);
    ...
    private static BlockPattern getWitherBossPattern() {
        if (witherBossPattern == null) {
            witherBossPattern = BlockPatternBuilder.start().aisle("^", "#").where('#', pos -> pos.getBlockState().isOf(ModBlocks.PEDISTAL)).where('^', CachedBlockPosition.matchesBlockState(BlockStatePredicate.forBlock(ModBlocks.ENERGY_CRYSTAL_DRAGON))).build();
        }
