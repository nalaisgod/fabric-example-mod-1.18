...
public class OriginiteBlasterBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof OriginiteBlasterEntity) {
                ItemScatterer.spawn(world, pos, (OriginiteBlasterEntity)blockEntity);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new OriginiteBlasterEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.ORIGINITE_BLASTER, OriginiteBlasterEntity::tick);
    }
