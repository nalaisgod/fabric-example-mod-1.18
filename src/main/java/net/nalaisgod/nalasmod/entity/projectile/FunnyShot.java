...
public class FunnyShot extends PersistentProjectileEntity implements IAnimatable {
    ...
    public FunnyShot(EntityType<? extends FunnyShot> entityType, World world) {
    ...
    public FunnyShot(World world, LivingEntity owner) {
        super(EntityRegistry.ROCKET, owner, world);
        this.shooter = owner;
    }

    protected FunnyShot(EntityType<? extends FunnyShot> type, double x, double y, double z, World world) {
        this(type, world);
    }

    protected FunnyShot(EntityType<? extends FunnyShot> type, LivingEntity owner, World world) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<FunnyShot>(this, "controller", 0, this::predicate));
    }
