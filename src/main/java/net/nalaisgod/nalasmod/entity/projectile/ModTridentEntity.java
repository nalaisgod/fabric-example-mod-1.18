...
public class ModTridentEntity
    ...
    public ModTridentEntity(EntityType<? extends net.minecraft.entity.projectile.TridentEntity> entityType, World world) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        this.setVelocity(this.getVelocity().multiply(-0.01, -0.5, -0.01));
        float g = 1.0f;
