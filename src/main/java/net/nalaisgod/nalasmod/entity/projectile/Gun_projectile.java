...
public class Gun_projectile extends PersistentProjectileEntity {
    ...
    public Gun_projectile(EntityType<? extends Gun_projectile> entityType, World world) {
        super(entityType, world);
        this.pickupType = PersistentProjectileEntity.PickupPermission.DISALLOWED;
    }

    public Gun_projectile(World world, LivingEntity owner) {
            super(EntityType.SPECTRAL_ARROW, owner, world);
        this.shooter = owner;
    }


    protected Gun_projectile(EntityType<? extends Gun_projectile> type, double x, double y, double z, World world) {
        this(type, world);
    }

    protected Gun_projectile(EntityType<? extends Gun_projectile> type, LivingEntity owner, World world) {
