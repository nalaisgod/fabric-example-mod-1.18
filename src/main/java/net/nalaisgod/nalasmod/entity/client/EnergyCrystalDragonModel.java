...
public class EnergyCrystalDragonModel extends AnimatedGeoModel<CrystalEntityDragon> {
	@Override
	public Identifier getAnimationFileLocation(CrystalEntityDragon entity) {
		return new Identifier(NalasMod.MOD_ID, "animations/energy_crystal.animation.json");
	}

	@Override
	public Identifier getModelLocation(CrystalEntityDragon animatable) {
		return new Identifier(NalasMod.MOD_ID, "geo/energy_crystal.geo.json");
	}

	@Override
	public Identifier getTextureLocation(CrystalEntityDragon entity) {
		return new Identifier(NalasMod.MOD_ID, "textures/block/energy_crystal_dragon.png");
	}
}